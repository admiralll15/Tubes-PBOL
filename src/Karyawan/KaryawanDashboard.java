...
public class KaryawanDashboard extends JFrame {
    ...
    private void initComponents() {
        ...
        // Title
        JLabel title = new JLabel("KARYAWAN DASHBOARD");
        ...
        // Tombol Status Cuti
        JButton btnStatusCuti = new JButton("✓ STATUS CUTI");
        btnStatusCuti.setPreferredSize(btnSize);
        btnStatusCuti.setMaximumSize(btnSize);
        btnStatusCuti.setAlignmentX(Component.CENTER_ALIGNMENT);
        styleButtonGradient(btnStatusCuti, new Color(0, 198, 167), new Color(0, 114, 255));
        contentPanel.add(btnStatusCuti);
        contentPanel.add(Box.createVerticalStrut(20));
