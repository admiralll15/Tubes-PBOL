...
/**
 * AdminDashboard - Rewritten dengan hardcode, tema putih-biru
 * Main dashboard untuk Admin user navigation
 */
public class AdminDashboard extends JFrame {
    ...
    private void initComponents() {
        ...
        setTitle("Admin Dashboard - Sistem Manajemen Absensi dan Penggajian");
        setResizable(true);
        ...
        // Header
        JPanel headerPanel = GUITemplate.createHeaderPanel("ADMIN DASHBOARD");
        ...
        gbc.gridx = 0;
        gbc.gridy = 0;
        JButton btnAbsensi = createDashboardButton("✓ Absensi Harian", GUITemplate.ACCENT_BLUE);
        ...
        gbc.gridx = 1;
        gbc.gridy = 0;
        JButton btnDataKaryawan = createDashboardButton("👥 Data Karyawan", new Color(156, 39, 172));
        btnDataKaryawan.addActionListener(evt -> openDataKaryawan());
        dashboardPanel.add(btnDataKaryawan, gbc);
        ...
        // Button Laporan Penggajian
        gbc.gridx = 1;
        gbc.gridy = 1;
        JButton btnLaporanGaji = createDashboardButton("💰 Laporan Penggajian", new Color(76, 175, 80));
        btnLaporanGaji.addActionListener(evt -> openLaporanPenggajian());
        dashboardPanel.add(btnLaporanGaji, gbc);
